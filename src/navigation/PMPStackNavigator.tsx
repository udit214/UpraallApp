...
const PMPStackNavigator = ({ route }) => {
  const { project } = route.params;

  return (
    <Stack.Navigator>
      <Stack.Screen name="PAndPDocumentPage"  options={{ headerShown: false}}>
        {props => <PAndPDocumentPage {...props} project={project} />}
      </Stack.Screen>
...
export default PMPStackNavigator;
